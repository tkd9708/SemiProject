...
$(function(){
	var label1 = "<%=dto.getLabel1()%>";
	var label2 = "<%=dto.getLabel2()%>";
	$("#selLabel1").val(label1).prop("selected", true);
	$("#selLabel2").val(label2).prop("selected", true);
	
	$("#spotdelete").click(function(){
        
       if(confirm("정말 삭제하시겠습니까?")){
          $.ajax({
         	type:"post",
         	dataType:"html",
         	url:"spot/spotdelete.jsp",
         	data:{"contentsid":"<%=contentsid%>"},
         	success:function(data){
            	location.href="index.jsp?main=spot/spotlist.jsp?area=" + label2;
...
<div class="updatemain">
   ...
   <tr>
      ...
      <td>
         <input type="text" name="contentsid" required="required" value="<%=contentsid%>">
      </td>
   </tr>
   <tr>
      <td >이름</td>
      <td>
         <input type="text" name="title" required="required" value="<%=dto.getTitle()%>">
      </td>
   </tr>
   <tr>
      <td colspan="2" >
      ...
      <span>행정시</span>
            &nbsp;&nbsp;
         <select name="label1" id="selLabel1" required="required" style="width:150px">
      ...
      <span>지역명</span>
            &nbsp;&nbsp;
         <select name="label2" id="selLabel2" required="required" style="width:150px">
            <option value="none" disabled="disabled" selected="selected">선택</option>
   ...
   <tr >
      ...
      <div style="display:flex">
         <input type="text" name="addr" id="addr" required="required" placeholder="주소" style="width:250px" value="<%=dto.getRoadaddr()%>">
   ...
   <tr>
      <td colspan="2">
         <div style="display:inline-flex">
            <span>위도</span>   
            &nbsp;&nbsp;&nbsp;
            <input type="text" name="latitude" required="required" readonly="readonly" value="<%=dto.getLatitude()%>">
         </div>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <div style="display:inline-flex">
            <span>경도</span>   
            &nbsp;&nbsp;&nbsp;
            <input type="text" name="longitude" required="required" readonly="readonly" value="<%=dto.getLongitude()%>">
         </div>
      </td>
   </tr>
   <tr>
   ...
   <tr>
      <td >태그</td>
      <td>
         <input type="text" name="tag" value="<%=dto.getTag()%>">
      </td>
   </tr>
   <tr>
      <td >소개</td>
      <td>
         <textarea name="introduction" cols="40" rows="8"><%=dto.getIntroduction()%></textarea>
      </td>
   </tr>
   <tr>
